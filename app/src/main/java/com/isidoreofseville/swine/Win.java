...
public class Win extends Activity {
    Button btnNext;
    TextView txtGameWin, txtCorrectAnswer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        soundPlayer.playPigWin();

        Intent intent = getIntent();
        correctAnswer = intent.getStringExtra("correctAnswer");

        btnNext = findViewById(R.id.btnNext);
        txtGameWin = findViewById(R.id.txtGameWin);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Win.this, Game.class).addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION));
    ...
    private void setFonts(){
        TextView[] tv2 = {btnNext, txtGameWin, txtCorrectAnswer};
